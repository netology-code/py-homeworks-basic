...
## Как сдавать задачи
Пишите код в IDE (рекомендуем [Pycharm](https://www.jetbrains.com/ru-ru/pycharm/download/other.html), версия PyCharm Community Edition, инструкцию по установке вы найдете на сайте).  
