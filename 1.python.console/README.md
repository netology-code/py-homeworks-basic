...
## Задача №3
Робот-Кеша.
Написать программу, которая здоровается с пользователем два раза. 
Пользователь вводит своё имя.
После этого программа выводит "Добрый день" и два раза имя.
Пример:
```
Как Вас зовут? Пётр

Вывод:
Добрый день, Петр Петр
```
