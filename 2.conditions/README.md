...
2. Если количество детей больше 3, то скидка будет от базовой ставки будет 1%.
3. Если у клиента зарплатный проект в этом банке, то скидка от базовой ставки будет 0.5%.
4. Если в этом же банке будет оформлена страхование, то сикдка от базовой ставки будет 1.5%
